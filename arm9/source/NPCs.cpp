...
const NPC gameNPCs[] = {
    {
        ...
        (u8 *)kingFigureTiles, (u16 *)kingFigurePal, "King",
...

    {
        ...
        (u8 *)civilian1FigureTiles, (u16 *)civilian1FigurePal, "Boy",
...

    {
        ...
        (u8 *)civilian2FigureTiles, (u16 *)civilian2FigurePal, "Girl",
...

    {
        ...
        (u8 *)civilian3FigureTiles, (u16 *)civilian3FigurePal, "Woman",
...

    {
        ...
        (u8 *)civilian4FigureTiles, (u16 *)civilian4FigurePal, "Woman",
...

    {
        ...
        (u8 *)civilian5FigureTiles, (u16 *)civilian5FigurePal, "Man",
...

    {
        ...
        (u8 *)civilian6FigureTiles, (u16 *)civilian6FigurePal, "Fisherman",
...

    {
        ...
        (u8 *)civilian7FigureTiles, (u16 *)civilian7FigurePal, "Boy",
        "Hi! You can buy some good stuff in the \3shop\3!"
    },

    {
        &civilianFigure[7], 210, 20, 0, 110, LEVEL7, DIR_DOWN,
        (u8 *)civilian8FigureTiles, (u16 *)civilian8FigurePal, "Young Lady",
...

    {
        ...
        (u8 *)civilian9FigureTiles, (u16 *)civilian9FigurePal, "Man",
...

    {
        ...
        (u8 *)civilian10FigureTiles, (u16 *)civilian10FigurePal, "Young Lady",
...

    {
        ...
        (u8 *)civilian11FigureTiles, (u16 *)civilian11FigurePal, "Woman",
...

    {
        ...
        (u8 *)civilian12FigureTiles, (u16 *)civilian12FigurePal, "Lumberjack Donni's Son",
...

    {
        ...
        (u8 *)lumberjackFigureTiles, (u16 *)lumberjackFigurePal, "Lumberjack Donni",
...

    {
        ...
        (u8 *)lumberjack1FigureTiles, (u16 *)lumberjack1FigurePal, "Lumberjack Remi",
...

    {
        ...
        (u8 *)bartenderFigureTiles, (u16 *)bartenderFigurePal, "Teller",
...

    {
        ...
        (u8 *)demitriFigureTiles, (u16 *)demitriFigurePal, "Dimitri",
...

    {
        ...
        (u8 *)dingFigureTiles, (u16 *)dingFigurePal, "Ding",
        "Get out of here!"
    },

    {
        &dangFigure, 160, 64, 0, 0, LEVEL14, DIR_DOWN,
        (u8 *)dangFigureTiles, (u16 *)dangFigurePal, "Dang",
        "Get out of here!"
    },

    {
        &dongFigure, 124, 75, 0, 0, LEVEL15, DIR_DOWN,
        (u8 *)dongFigureTiles, (u16 *)dongFigurePal, "Dong",
        "Get out of here!"
    },

    {
        &vardaFigure, 192, 109, 0, 0, LEVEL18, DIR_UP,
        (u8 *)vardaFigureTiles, (u16 *)vardaFigurePal, "Varda",
        "Nooo...! My plans...!"
    },
...

    {
        ...
        (u8 *)queenFigureTiles, (u16 *)queenFigurePal, "Queen",
        ""
    },
